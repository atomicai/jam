...
from jam.ir.document_store.base.store import Document
from jam.ir.document_store.elastic.store import ElasticDocStore
from jam.ir.engine import base as base_engine
...
class BM25Retriever(base_engine.IR):
    ...
    def retrieve_top_k(
        ...
        index = self.store.index if index is None else index
